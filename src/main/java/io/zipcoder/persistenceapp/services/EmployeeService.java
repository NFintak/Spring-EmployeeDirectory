...
//    public Iterable<Employee> findReptHierarchy(Employee employee) {
//        ArrayList<Employee> reptHierarchy = new ArrayList<>();
//        while (employee.getManager() != null) {
//            reptHierarchy.add(employee.getManager());
//            employee = employee.getManager();
//        }
//        return reptHierarchy;
//    }
//
...
//
//    //get dept, title, etc of employee. separate calls for each or all in one method?
//
...
//    public Boolean deleteByDept(Long id) {
//        for (Employee employee : employeeIndex()) {
//            if (employee.getDeptNum().equals(id)) {
...
//    public Boolean deleteByManager(Employee manager) {
//        for (Employee employee : employeeIndex()) {
//            if (employee.getManager().equals(manager)) {
//                repo.delete(employee);
//            }
